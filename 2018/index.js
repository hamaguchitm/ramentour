...
function initMap() {
    var center = new google.maps.LatLng(35.6844975, 139.8135138);
    ...
    var srcUrl = './img/181103-ramentour2018-four-u.png.png'
    overlayOptions = {
        width: 696,
        height: 980,
        opacity: 1.0,
    ...
    layerOptions = {
        query: {
            select: 'latitude',
            from: '1VvjvNIOutwjZwtir3KhfXSm5XdIDGnvdzULuxPR7',
            where: ''
        },
        options: {
              styleId: 2,
